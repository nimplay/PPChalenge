...
ActiveRecord::Schema[8.0].define(version: 2025_05_16_185308) do
  ...
  create_table "categories", force: :cascade do |t|
    ...
    t.index ["updater_id"], name: "index_categories_on_updater_id"
  end
  ...
  add_foreign_key "categories", "users", column: "updater_id"
